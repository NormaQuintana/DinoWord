...
func _display_new_vocabulario_question():
    ...
    var vocabulario_data = GlobalData.data.escuela.vocabulario
...
func _display_new_ordenar_question():
    ...
    var ordenar_data = GlobalData.data.escuela.ordenar
...
func _display_new_frases_question():
    ...
    var frases_data = GlobalData.data.escuela.frases
...
func _on_voz_pressed() -> void:
    ...
    panel.visible = true
    # Aquí ya estás usando GlobalData.data.escuela.vocabulario, lo cual es correcto.
    var vocabulario = GlobalData.data.escuela.vocabulario
    print(vocabulario)
